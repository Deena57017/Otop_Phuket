...
<body class="w3-light-grey">
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="w3-row-padding w3-margin-bottom">
            <a href="{{url('order/statistic')}}" style="text-decoration: none" class="w3-quarter">
                <div class="w3-container w3-red w3-padding-16">
                    <div class="w3-left"><i class="fa fa-chart-bar w3-xxxlarge"></i></div>
                    <div class="w3-clear"></div>
                    <h4>สรุปสถิติการสั่งซื้อ</h4>
                </div>
            </a>
            <a href="#" style="text-decoration: none" class="w3-quarter">
                <div class="w3-container w3-blue w3-padding-16">
                    <div class="w3-left"><i class="fa fa-list w3-xxxlarge"></i></div>
                    <div class="w3-clear"></div>
                    <h4>รายการสั่งสินค้าทั้งหมด</h4>
                </div>
            </a>
