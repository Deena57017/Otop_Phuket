                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($payments as $index => $payment)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach($paymentDetails as $paymentDetail)
                                                            @if ($paymentDetail->payment_id == $payment->payment_id)
                                                                ...
                                                                {{ $paymentDetail->order_detail_quantity }} ( ชิ้น )
                                                                x
                                                                {{ $paymentDetail->order_detail_total / $paymentDetail->order_detail_quantity }} ( ราคาต่อชิ้น )
                                                                =
                                                                {{ $paymentDetail->order_detail_total }} ( บาท )
                                                                <br><br>
                                                            @endif
                                                    ...
                                                    <td align="center">
                                                        {{ $paymentDetail->payment_total }} บาท
                                                    </td>
                                                    <td>
                                                        ...
                                                        @else
                                                            ...
                                                            <br><br>
                                                            <span class="label label-success">
                                                                ( วันที่จ่าย : {{ $payment->payment_date }} )
                                                            </span>
                                                            <br><br>
