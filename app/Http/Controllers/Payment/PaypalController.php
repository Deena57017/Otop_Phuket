...
class PaypalController extends Controller {
    ...
    private function preparePaypalPaymentData($paymentId, $products) {
        ...
        $prepareData['redirect_urls']['return_url'] = 'http://127.0.0.1:8000/payment/status/' . $paymentId;
        $prepareData['redirect_urls']['cancel_url'] = 'http://127.0.0.1:8000/payment/status/' . $paymentId;
